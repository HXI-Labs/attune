...
collar F1. Segment margin clears +0.05, but collar F1 fails >= 0.25, so
STARSS23 timing stays unwired; DCASE timing is unchanged. Language remains
unverified. STARSS23 is the MIT natural-spatial-audio dataset with 100 ms
