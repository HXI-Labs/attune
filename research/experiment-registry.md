...
| timing-frame-starss23-v1 | 2026-08-27 | this PR | 80/40 bounded STARSS23 development windows; manifests `1e2ad11b…` / `edc136db…` | frozen SenseVoiceSmall frames, FunASR Model License v1.1; separate 32,897-param laughter MLP; STARSS23 MIT | 53/27 room-disjoint development; 40 official dev-test room/file-disjoint inspection | 0 | segment F1 0.7381 vs 0.4894 whole-clip; collar F1 0.1159 vs 0 | `research/starss23-localization-results.json`; `research/timing-holes-results.json` | Segment gate passes; gated laugh wiring only; weak collar is not merge-quality; gold gate closed |
