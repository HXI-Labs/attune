...
| timing-frame-dcase-v1-blocked | 2026-08-27 | this PR | existing hashed 216-development/100-public-test DCASE protocol; local audio cache absent | frozen SenseVoiceSmall frames, FunASR Model License v1.1; 66,051-param MLP | file-disjoint development train/validation; source-disjoint public test | 0 | blocked before extraction; no frame metric | `research/timing-holes-results.json` | Do not wire timestamps; gate closed |
