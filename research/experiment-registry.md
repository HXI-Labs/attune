...
| timing-frame-dcase-v1 | 2026-08-27 | this PR | hashed 216-development/100-public-test DCASE protocol | frozen SenseVoiceSmall frames, FunASR Model License v1.1; 66,051-param MLP | 168/48 scene/file-disjoint development; source-disjoint public test | 0 | segment F1 0.7285 vs 0.3183 whole-clip; collar F1 0.4637 vs 0 | `research/dcase-frame-localization-results.json`; `research/timing-holes-results.json` | +0.4102 clears timing gate; wire only three overlap labels; gold gate closed |
