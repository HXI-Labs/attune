...
epochs, then 0.3974 / 0.0303 after one longer decoder pass; the segment margin
clears +0.05 but collar F1 fails the fixed 0.25 gate, so STARSS23 timestamps
stay unwired. Details are in `research/timing-holes.md`.
